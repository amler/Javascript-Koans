describe("About Objects", function () {
    ...
    var megalomaniac = {
      ...
      battleCry: function (noOfBrains) {
        return "They are " + this.henchman + " and the" +
          //the function call Array() creates and initialises a new Array object
          // creating an array length of 5 but values not defined so undefined is in each array?
          //this is just creating repitition in Joins separator...
  ...
  it("should confirm that when a function is attached to an object, 'this' refers to the object", function () {
    // date object returns today's date and time and does not need any object to be called
  ...
  it("should use prototype to add to all objects", function () {
      ...
      // adding to the coloured circle only
      colouredCircle.colour = "red";

      expect(simpleCircle.colour).toBe(undefined);
      expect(colouredCircle.colour).toBe('red');
      // Adding the describe function to both instances of Circle.
